...
|-|-|-|-|-|
|1|Регистрация нового пользователя|1. Перейти на страницу регистрации. 2. Ввести корректные данные (email или номер телефона). 3. Нажать "Зарегистрироваться".|Пользователь успешно зарегистрирован, появляется сообщение о подтверждении|Выполнено. Test case пройден.|
